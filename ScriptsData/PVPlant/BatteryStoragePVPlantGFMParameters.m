...
battery.vbat_1=battery.vbat_nominal*0.999;           % Voltage V1 when charge is AH1
...
GFMBatteryController.Q_ref=0.01;     % Reactive power referance of Battery inverter
...
GFMBatteryController.voltagedroop=1.6;                      % VSM voltage droop 1.05
GFMBatteryController.voltagecontrolki=0.05;                    % VSM voltage controller integral gain
...
GFMBatteryController.currentcontrollerki=0.00171;             % VSM current controller integral gain
...
GFLBatteryController.Td=3.5e-3; % Time delay in sec for BESS inverter frequency & voltage sensig 
