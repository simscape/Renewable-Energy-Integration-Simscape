...
suite = matlab.unittest.TestSuite.fromFile(...
    fullfile(topFolder, "Tests", "GridCodeUnitTest.m"));
%% Create test runner
...
coverageReport = matlab.unittest.plugins.codecoverage.CoverageReport( ...
    ...
    MainFile = "Grid Code Test Coverage" + relStr + ".html" );
plugin = matlab.unittest.plugins.CodeCoveragePlugin.forFile(...
    [...
    fullfile(topFolder, "ScriptsData", "GridCodeUtils", "testModelparameters.m")...
    fullfile(topFolder, "ScriptsData", "GridCodeUtils", "mustHaveFields.m"), ...
    fullfile(topFolder, "ScriptsData", "GridCodeUtils", "gridCodeComplianceChecker.m"),...
    fullfile(topFolder, "ScriptsData", "GridCodeUtils", "DynamicSignalGenerator.m")], ...
