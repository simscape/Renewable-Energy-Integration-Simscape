...
plugin = matlab.unittest.plugins.CodeCoveragePlugin.forFile( ...
  [ ...
  fullfile(topFolder, "ScriptsData", "BatteryStoragePVPlantGFMMainPage.mlx")
  fullfile(topFolder, "ScriptsData", "BatteryStoragePVPlantGFMComparisonGFLvsGFM.m")
  fullfile(topFolder, "ScriptsData","BatteryStoragePVPlantGFMParameters.m")          
    ], ...
